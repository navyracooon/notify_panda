...
class PandaParser:
    ...
    def parse_all_assignment_info() -> List[Assignment]:
        request_dicts = PandaParser.get_all_assignment_info()[
        ...
        assignment_list = [
            Assignment(
                ...
                id=request_dict["id"],
                instructions=BeautifulSoup(
                    request_dict["instructions"], "html.parser").text,
    ...
    def get_all_assignment_info() -> Dict:
        ...
        all_assignment_info_url = ("https://panda.ecs.kyoto-u.ac.jp/"
    ...
    def login_panda() -> None:
        if not PandaParser.__logged_in:
            login_url = (
                    ...
                    "?service=https%3A%2F%2Fpanda.ecs.kyoto-u.ac.jp%2F"
            ...
            raw_lt = soup.select("#fm1 > div.row.btn-row > "
                                 "input[type=hidden]:nth-of-type(1)")
            lt = raw_lt[0].attrs["value"]

            raw_execution = soup.select("#fm1 > div.row.btn-row > "
                                        "input[type=hidden]:nth-of-type(2)")
